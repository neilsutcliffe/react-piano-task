...
export default ({ note }) => {
    var keyColor = note.Ivory ? style.white : style.black;

    // Add offset classes if needed
    var leftmost = note.midiName.includes("Db") || note.midiName.includes("Gb");
    var rightmost = note.midiName.includes("Eb") || note.midiName.includes("Bb");
